...
const promise = [
    {
        img: 'https://images-na.ssl-images-amazon.com/images/G/01/US-hq/2022/img/Certified_Refurbished/US_promise1_slot12.gif',
        name: 'Quality you can afford',
        desc: 'Shop Amazon Renewed for products that have been refurbished at affordable prices so you can save on the brands you love.',
    },
    {
        img: 'https://images-na.ssl-images-amazon.com/images/G/01/US-hq/2022/img/Certified_Refurbished/US_promise2_slot12.gif',
        name: 'Products you can trust',
        desc: 'All products have been professionally inspected, tested and cleaned by Amazon-qualified suppliers.',
    },
    {
        img: 'https://images-na.ssl-images-amazon.com/images/G/01/US-hq/2022/img/Certified_Refurbished/US_promise3_slot12.gif',
        name: 'Purchases with an impact',
        desc: 'Each Renewed purchase extends the lifetime of a device and keeps e-waste out of landfills.',
    },
    {
        img: 'https://images-na.ssl-images-amazon.com/images/G/01/US-hq/2022/img/Certified_Refurbished/US_bannerhero3guarantee_slot1.gif',
        name: 'Money back guarantee',
        desc: 'If you’re not fully satisfied, you have 90 days to return for a replacement or full refund.',
        link: 'See terms >',
    },
];
...
const freqQuestions = [
    {
        question: 'What is Amazon Renewed?',
        answer: 'Amazon Renewed is your trusted destination for pre-owned, refurbished products. Products sold on Amazon Renewed are professionally inspected and tested to work as expected by an Amazon qualified and performance-managed supplier. If we source products from a third-party seller, the third-party seller tests and inspects the product.',
    },
    {
        question:
            'What should I expect to receive with my Amazon Renewed purchase?',
        answer: 'Renewed products will come with accessories that may not be original, but will be compatible and fully functional. Amazon Renewed products will be packaged in either original packaging or in a new and clean cardboard box. When present, batteries have a capacity that exceeds 80% of the original battery life.',
    },
    {
        question:
            'In what condition can I expect my Amazon Renewed product to be?',
        answer: 'Product will be restored to its original factory settings and will be in one of the following cosmetic conditions: Premium or Excellent - no signs of cosmetic damage when held 12 inches away. Good - Light scratches, barely visible when holding the device 12 inches away. Acceptable - Scratches visible when holding the device 12 inches away and perceptible to the touch.',
    },
    {
        question: 'What if I’m not satisfied with the product I receive?',
        answer: 'We want you to be delighted with your purchase. If the product does not look or work as expected, you are eligible for a replacement or refund within 90 days of receipt with the Amazon Renewed guarantee. We can also help you troubleshoot technical problems and assist with returns. From ‘Your Orders’, click on ‘Get Product Support’ or click on chat/phone for Amazon Customer Service. Learn more about the Amazon Renewed Guarantee.',
    },
];

export { data, avaliability, departments, products, promise, freqQuestions };
